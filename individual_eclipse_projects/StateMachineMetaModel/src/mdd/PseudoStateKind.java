 ...
 * <!-- end-user-doc -->
 * @see mdd.MddPackage#getPseudoStateKind()
 * @model
 * @generated
 */
public enum PseudoStateKind implements Enumerator {
	 ...
	 * @ordered
	 */
	ENTRY_POINT(5, "entryPoint", "entryPoint"),
	 ...
	 * @ordered
	 */
	EXIT_POINT(6, "exitPoint", "exitPoint"),
	 ...
	 * @ordered
	 */
	TERMINATE(7, "terminate", "terminate"),
	 ...
	 * @ordered
	 */
	DEEP_HISTORY(8, "deepHistory", "deepHistory"),
	 ...
	 * @ordered
	 */
	SHALLOW_HISTORY(9, "shallowHistory", "shallowHistory");
	 ...
	 * @ordered
	 */
	public static final int ENTRY_POINT_VALUE = 5;
	 ...
	 * @ordered
	 */
	public static final int EXIT_POINT_VALUE = 6;
	 ...
	 * @ordered
	 */
	public static final int DEEP_HISTORY_VALUE = 8;
	 ...
	 * @ordered
	 */
	public static final int SHALLOW_HISTORY_VALUE = 9;
